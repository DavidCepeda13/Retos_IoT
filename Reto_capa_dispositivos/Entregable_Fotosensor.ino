...
//----------------------------------------------------
//
//variables para foto sensor (LTR)
int luzRaw = 0;
float luminosidad = 0;
...
void loop()
{
  ...
  luzRaw = analogRead(A0);
  luminosidad = map(luzRaw, 0, 1023, 0, 100);
